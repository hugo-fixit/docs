...
分享一个 canvas 实现的小鱼游动动画效果。

<!--more-->

## 效果预览

打开 [作者博客](https://lruihao.cn)，滑动到最底部，即可看到效果。
...
源码来自互联网，原作者不详，我只是移除了依赖 jQuery 的部分，并适配了 FixIt 主题。

如需修改颜色、高度等样式，请自行修改 `flyfish.js` 文件。
