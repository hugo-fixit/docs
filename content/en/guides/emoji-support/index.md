...
To enable emoji globally, set `enableEmoji` to `true` in your [site configuration](https://gohugo.io/configuration/all/) and then you can type emoji shorthand codes directly in content files.
